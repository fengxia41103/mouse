...
data_folder = 'frame_by_frame_model/train/train_data/'
video_folder = 'frame_by_frame_model/train/train_video/'
...
for i in range(len(os.listdir(data_folder))):
    ...
    all_videos, all_labels = get_train_xy(data_folder, video_folder, start = i, end = i+1)
    ...
    for j in range(0,10,gap):
        ...
        train_x, train_y = prepare_video_data_31(all_videos, all_labels, j, j+gap)
        ...
        class_weight = {0:non_grooming_ratio, 
                            1:grooming_ratio}
        print("Ratio of Grooming and Non grooming time in this clip:\n", class_weight)
        print()
        ...
        if j != 0 and first_time == False:
            #save_name = 'frame_by_frame_model/train/models/Best_model.h5'
            save_name = 'frame_by_frame_model/train/models/Best_model_31length.h5'
...
plot_name = "frame_by_frame_model/train/loss_and_acc_new_31length.png"
