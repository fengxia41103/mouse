...
def print_frames(
    data, connections, circle_radius=5, fn="../video/D1_90min_black.mp4"
):
    """
    ...
    result = cv2.VideoWriter(
        fn, cv2.VideoWriter_fourcc(*"mp4v"), 30.0, (640, 480), False
    )
    ...
    for row in range(data.index[0], len(data) + data.index[0]):
        ...
        for connection in connections:
            ...
            start, end = fetch_point(data, connection[0], row), fetch_point(
                data, connection[1], row
            )
            # print(start, end)
...
if __name__ == "__main__":
    ...
    fn = (
        path
        + "D1#-2020-09-17T20_56_41DLC_resnet50_july_dlc_500_framesJul8shuffle1_500000.h5"
    )
    ...
    connections = [
        ...
        ("c_center", "tail_base"),
        ("tail_base", "tail_tip"),
        ("head_base", "f_r_shoulder"),
        ("head_base", "f_l_shoulder"),
        ("l_center", "f_l_shoulder"),
        ("r_center", "f_r_shoulder"),
        ("l_center", "r_l_shoulder"),
        ("r_center", "r_r_shoulder"),
        ("r_l_shoulder", "tail_base"),
        ("r_r_shoulder", "tail_base"),
    ]
